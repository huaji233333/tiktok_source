...
public class GetScaleHandler extends WebEventHandler {
  public GetScaleHandler(WebViewManager.IRender paramIRender, String paramString, int paramInt) {
  ...
  public String act() {
    ...
    try {
      ...
      AppBrandLogger.e("tma_GetScaleHandler", new Object[] { exception });
    } 
  }
...
/* Location:              C:\Users\august\Desktop\tik\df_miniapp\classes.jar!\com\tt\miniapp\webbridge\sync\map\GetScaleHandler.class
