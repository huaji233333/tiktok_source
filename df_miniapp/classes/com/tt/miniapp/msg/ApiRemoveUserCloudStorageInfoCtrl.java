...
public class ApiRemoveUserCloudStorageInfoCtrl extends b {
  public ApiRemoveUserCloudStorageInfoCtrl(String paramString, int paramInt, e parame) {
    super(paramString, paramInt, parame);
  }
  
  public void act() {
    try {
      String str3 = (new JSONObject(this.mArgs)).optString("keyList");
      ...
      if (!TextUtils.isEmpty(str4) && !TextUtils.isEmpty(str1) && !TextUtils.isEmpty(str2)) {
        final i tmaPostRequest = new i(AppbrandConstant.OpenApi.getInst().getREMOVE_CLOUD_STORAGE_URL(), "POST");
        i.a("aid", str1);
        i.a("appid", str2);
        i.a("keyList", Uri.encode(str3));
        i.a("session", str4);
        Observable.create(new Function<String>() {
              public String fun() {
                String str = NetManager.getInst().request(tmaPostRequest).a();
                AppBrandLogger.d("tma_ApiRemoveUserCloudStorageInfoCtrl", new Object[] { "requestResult = ", str });
                return str;
              }
            }).schudleOn(Schedulers.longIO()).subscribe((Subscriber)new Subscriber.ResultableSubscriber<String>() {
              public void onError(Throwable param1Throwable) {
                AppBrandLogger.e("tma_ApiRemoveUserCloudStorageInfoCtrl", new Object[] { Log.getStackTraceString(param1Throwable) });
                ApiRemoveUserCloudStorageInfoCtrl.this.callbackFail(param1Throwable);
              }
              ...
              public void onSuccess(String param1String) {
                try {
                  if (!TextUtils.isEmpty(param1String)) {
                    ...
                    ApiRemoveUserCloudStorageInfoCtrl.this.callbackFail(a.a("%s errorCode = %s", new Object[] { str, Integer.valueOf(i) }));
                    return;
                  } 
                  ApiRemoveUserCloudStorageInfoCtrl.this.callbackFail("requestResult is null");
                  return;
                } catch (JSONException jSONException) {
                  AppBrandLogger.e("tma_ApiRemoveUserCloudStorageInfoCtrl", new Object[] { "json exception ", jSONException });
                  ApiRemoveUserCloudStorageInfoCtrl.this.callbackFail((Throwable)jSONException);
                  return;
                } 
              }
            });
      ...
      AppBrandLogger.e("tma_ApiRemoveUserCloudStorageInfoCtrl", new Object[] { str1 });
      return;
    } catch (Exception exception) {
      AppBrandLogger.stacktrace(6, "tma_ApiRemoveUserCloudStorageInfoCtrl", exception.getStackTrace());
...
/* Location:              C:\Users\august\Desktop\tik\df_miniapp\classes.jar!\com\tt\miniapp\msg\ApiRemoveUserCloudStorageInfoCtrl.class
