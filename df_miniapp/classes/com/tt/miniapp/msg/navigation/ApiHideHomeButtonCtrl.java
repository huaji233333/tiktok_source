...
public class ApiHideHomeButtonCtrl extends b {
  public ApiHideHomeButtonCtrl(String paramString, int paramInt, e parame) {
    ...
    AppbrandContext.mainHandler.post(new Runnable() {
          public void run() {
            try {
              ...
              AppBrandLogger.e("ApiHideHomeButtonCtrl", new Object[] { exception });
              ApiHideHomeButtonCtrl.this.callbackFail(exception);
            } 
          }
        });
  }
