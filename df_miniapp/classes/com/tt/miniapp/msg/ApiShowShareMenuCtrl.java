...
public class ApiShowShareMenuCtrl extends b {
  public ApiShowShareMenuCtrl(String paramString, int paramInt, e parame) {
  ...
  public void act() {
    ...
    if (bool) {
      ...
      if (!TextUtils.isEmpty(str)) {
        AppBrandLogger.d("ApiShowShareMenuCtrl", new Object[] { "currentPage:", str });
        a.put(str, bool1);
      } else {
...
/* Location:              C:\Users\august\Desktop\tik\df_miniapp\classes.jar!\com\tt\miniapp\msg\ApiShowShareMenuCtrl.class
